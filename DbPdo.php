...
/*
 * Libreria de coneccion PDO travez del patron singletom
 */
class DbPdo {
    private $_dbh;
    private $_username = "root";
    private $_passwd = "root";
    private $dns = "mysql:host=localhost;dbname=cliente";
    ...
    private function __construct() {
        try {
            $this->_dbh = new PDO($this-> dns, $this-> _username, $this->_passwd);
